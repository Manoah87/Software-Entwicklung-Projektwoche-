...
namespace hfupilot.Models
{
    ...
    public partial class iWorld_HFU_AddOnEntities : DbContext
    {
        ...
        public virtual ObjectResult<sp_HandleSession_Result> sp_HandleSession(Nullable<int> i_SessionID)
        {
            var i_SessionIDParameter = i_SessionID.HasValue ?
                new ObjectParameter("i_SessionID", i_SessionID) :
                new ObjectParameter("i_SessionID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_HandleSession_Result>("sp_HandleSession", i_SessionIDParameter);
        }
    
        public virtual ObjectResult<sp_UpdateVerspaetung_Result> sp_UpdateVerspaetung(Nullable<int> i_SessionID, Nullable<int> i_PersonDatenplanID, Nullable<decimal> i_VerspaetetUm, string i_Kommentar)
        {
            var i_SessionIDParameter = i_SessionID.HasValue ?
                new ObjectParameter("i_SessionID", i_SessionID) :
                new ObjectParameter("i_SessionID", typeof(int));
    
            var i_PersonDatenplanIDParameter = i_PersonDatenplanID.HasValue ?
                new ObjectParameter("i_PersonDatenplanID", i_PersonDatenplanID) :
                new ObjectParameter("i_PersonDatenplanID", typeof(int));
    
            var i_VerspaetetUmParameter = i_VerspaetetUm.HasValue ?
                new ObjectParameter("i_VerspaetetUm", i_VerspaetetUm) :
                new ObjectParameter("i_VerspaetetUm", typeof(decimal));
    
            var i_KommentarParameter = i_Kommentar != null ?
                new ObjectParameter("i_Kommentar", i_Kommentar) :
                new ObjectParameter("i_Kommentar", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_UpdateVerspaetung_Result>("sp_UpdateVerspaetung", i_SessionIDParameter, i_PersonDatenplanIDParameter, i_VerspaetetUmParameter, i_KommentarParameter);
        }
    }
}
